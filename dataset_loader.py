...
def load_data():
    ...
    cve_cleaned, products_cleaned, vendors_cleaned = cleanup(cve, products, vendors)
    ...
    return cve_cleaned, products_cleaned, vendors_cleaned


def cleanup(cve, products, vendors):
    ...
    cve_cleaned = cve_cleaned[cve_cleaned['cvss'] != 0]  # Remove rows with CVSS score of 0
